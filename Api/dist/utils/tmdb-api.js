...
exports.getTVShowEpisodeDetailsUrl = exports.getTVShowSeasonDetailsUrl = exports.getTVShowDetailsUrl = exports.popularTVShowsUrl = exports.genresUrl = exports.getSearchTVShowUrl = void 0;
...
const getTVShowEpisodeDetailsUrl = (tvShowId, season, episode) => `${baseUrl}/tv/${tvShowId}/season/${season}/episode/${episode}?api_key=${TMBD_API_KEY}&language=en-US`;
exports.getTVShowEpisodeDetailsUrl = getTVShowEpisodeDetailsUrl;
