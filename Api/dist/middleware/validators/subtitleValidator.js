...
exports.createSubtitleValidator = createSubtitleValidator;
const updateSubtitleValidator = joi_1.default.object({
    language: joi_1.default.string()
        .length(2)
        .custom((value, helpers) => {
        if (!countries_list_1.languages.hasOwnProperty(value)) {
...
exports.updateSubtitleValidator = updateSubtitleValidator;
