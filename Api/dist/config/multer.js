...
exports.updateSubtitleMulter = exports.createSubtitleMulter = exports.subtitlesFolderPath = exports.tempFolderPath = exports.allowedMimeTypes = exports.allowedExtensions = void 0;
...
const fileFilterCreate = (req, file, cb) => __awaiter(void 0, void 0, void 0, function* () {
    const extension = '.' + file.originalname.split('.').pop();
    if (exports.allowedExtensions.includes(extension)) {
        const { error } = subtitleValidator_1.createSubtitleValidator.validate(req.body);
        if (!error) {
            cb(null, true);
        }
        else {
...
const fileFilterUpdate = (req, file, cb) => __awaiter(void 0, void 0, void 0, function* () {
    const extension = '.' + file.originalname.split('.').pop();
    if (exports.allowedExtensions.includes(extension)) {
        const { error } = subtitleValidator_1.updateSubtitleValidator.validate(req.body);
        if (!error) {
            cb(null, true);
        }
        else {
...
const createSubtitleMulter = (0, multer_1.default)({
    storage: storage,
    limits: {
...
exports.createSubtitleMulter = createSubtitleMulter;
const updateSubtitleMulter = (0, multer_1.default)({
    storage: storage,
    limits: {
        fileSize: fileSizeLimitMegabytes * 1024 * 1024,
    },
...
exports.updateSubtitleMulter = updateSubtitleMulter;
