...
subtitleRouter.get('', subtitles_1.getAllSubtitles);
subtitleRouter.post('', authMiddleware_1.authenticate, onlyMultipartDataAllowed_1.default, multer_1.subtitleMulter.array('files', 5), (0, bodyMiddleware_1.validateBody)(subtitleValidator_1.createSubtitleValidator), subtitles_1.addSubtitle);
subtitleRouter.put('/:subtitleId', authMiddleware_1.authenticate, onlyMultipartDataAllowed_1.default, multer_1.subtitleMulter.array('files', 5), (0, bodyMiddleware_1.validateBody)(subtitleValidator_1.updateSubtitleValidator), subtitles_1.updateSubtitle);
